...
/**
 * An implementation of {@link NxGzipCallback} that simply counts terms
 * 
 * @author Omer Dawelbeit (omerio)
 *
 */
public class TermCounterCallback implements NxGzipCallback {
