 ...
 *
 */
public class NTriple implements Triple {
	 ...
	 * @param object
	 */
	public NTriple(String subject, String predicate, String object) {
		super();
    ...
    public Triple create(Object subject, Object predicate, Object object) {
        ...
        return new NTriple((String) subject, (String) predicate, (String) object);
    }
	...
	public void set(String field, Object value) {
		...
		case TermType.predicate:
			this.setPredicate((String) value);
			break;
		case TermType.object:
			this.setObject((String) value);
			break;
	...
	public static Triple fromCSV(String[] terms) {
		return new NTriple(terms[0], terms[1], terms[2]);
	}
	 ...
	 * @return
	 */
	public static Set<NTriple> getTriplesForCriteria(String term, TermType type, String uri, Set<NTriple> triples) {
		Set<NTriple> matched = new HashSet<>();
	...
	public static Set<Triple> getTriplesForCriteria(String term, TermType type, String uri, 
			boolean inferred, Set<NTriple> triples) {
	 ...
	 */
	public NTriple clone() {
		NTriple triple = new NTriple(this.subject, this.predicate, this.object);
