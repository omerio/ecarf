 ...
 *
 */
public class ExtractCountTermsPartSubTask implements Callable<TermCounter> {

    private final static Log log = LogFactory.getLog(ExtractCountTermsPartSubTask.class);
    ...
    public ExtractCountTermsPartSubTask(String file, String bucket, String sourceBucket, TermCounter counter, CloudService cloud) {
        super();
        this.file = file;
