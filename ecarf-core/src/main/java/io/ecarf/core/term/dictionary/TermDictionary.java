...
public abstract class TermDictionary implements Serializable {
    ...
    /**
     * Given a value return a key
     * @param value
     * @return
     */
    public abstract String get(Integer value);
    ...
    public long encodeBlankNode(String blankNode) {
        ...
        Integer enc = this.get(blankNode);
        if(enc == null) {
    ...
    public void add(String part) {
        if(!this.containsKey(part)) {
            ...
            this.put(part, this.largestResourceId);
        }
    }
