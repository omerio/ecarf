 ...
 *
 */
public class TermDictionaryBidiConcurrent extends TermDictionary implements Serializable, ConcurrentDictionary {
    ...
    public TermDictionary getNonConcurrentDictionary() {
        ...
        for(Entry<Object, Object> entry: this.dictionary.entrySet()) {
            dict.put((String) entry.getKey(), (Integer) entry.getValue());
        }
